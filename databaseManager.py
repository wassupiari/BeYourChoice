...
class DatabaseManager:
    def __init__(self, uri="mongodb+srv://rcione3:rcione3@beyourchoice.yqzo6.mongodb.net/?retryWrites=true&w=majority&appName=BeYourChoice", db_name="BeYourChoice;"):
        """
    ...
    def get_collection(self, collection_name):
        if self.db is not None:  # Controllo corretto
